...
import framework.report.BankReportServiceImpl;
import framework.report.CreditReportServiceImpl;
import framework.report.ReportService;
import framework.service.command.Command;

import java.awt.*;

public class JDialogGenRepo extends javax.swing.JDialog
{
    String billstring;
	...
	public JDialogGenRepo(Frame parent)
	{
		super(parent);
	...
	public JDialogGenRepo(Command command)
	{
		this((Frame)null);
		this.command = command;
	}
