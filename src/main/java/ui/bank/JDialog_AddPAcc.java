...
public class JDialog_AddPAcc extends javax.swing.JDialog {
    ...
    public JDialog_AddPAcc(Command command, BankFrm parent) {
        super(parent);
    ...
    void JButtonOK_actionPerformed(java.awt.event.ActionEvent event) throws Exception {
        ...
        Customer customer = new PersonalAccount(JTextField_NAME.getText(), JTextField_EM.getText(),
                JTextField_BD.getText(), address);
