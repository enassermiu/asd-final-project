...
public class JDialog_AddCompAcc extends javax.swing.JDialog {
    ...
    public JDialog_AddCompAcc(Command command, BankFrm parent) {
        super(parent);
        parentframe = parent;
    ...
    void JButtonOK_actionPerformed(java.awt.event.ActionEvent event) throws Exception {
        ...
        Customer customer = new CompanyAccount(JTextField_NAME.getText(), JTextField_EM.getText(),
                JTextField_NoOfEmp.getText(), address);
        Account account = accountCreator.CreatAccount(customer, JTextField_ACNR.getText());
